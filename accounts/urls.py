...
from .views import register_view, login_view, profile_view, CustomPasswordChangeView, CustomLogoutView, user_notifications_view, user_notification_is_read_view, verify_email_view, resend_verification_view, phone_update_view
...
urlpatterns = [
    ...
    path('profile/phone/', phone_update_view, name='phone_update'),
